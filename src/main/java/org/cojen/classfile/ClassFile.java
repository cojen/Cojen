...
public class ClassFile {
		 ...
		 * the target.	These are classfile major and minor versions (e.g. <code>45, 3</code>), not 
		 * Java specifications (e.g. <code>1, 7</code>).	If you want to use a Java 
		 * specification, use {@link #setTarget(String)}.
		 *
		 * @param major The major version (45 to 51, inclusive).
		 * @param minor The minor version (0 except in the case of <code>major</code> 45, then 3).
