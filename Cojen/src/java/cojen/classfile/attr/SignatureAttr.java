...
public class SignatureAttr extends Attribute {
    ...
    public SignatureAttr(ConstantPool cp, String signature) {
        this(cp, SIGNATURE, signature);
    }

    public SignatureAttr(ConstantPool cp, String name, String signature) {
        super(cp, name);
        mSignature = cp.addConstantUTF(signature);
    }
